...
''')
        ...
        if IAplayer.IAdecision() or 'countess' in Ia_use_this:
            ...
            contested = input('O adversário útilizou a condessa. Gostaria de contestar? sim (1), não (0)\nSua ação: ')
            if contested == '1':
                if 6 in IAplayer.CardsInHand:
                    ...
                    if witchCardKill == '1' and IAplayer.CardsInHand[1] != -1:
                        ...
                        if CardInHand != 0:
                            ...
                            input(f'Você matou a carta da direita de seu oponente, e comprou 2 moedas. agora ele possui {CardInHand} carta e você tem {player1.SilverSerpents} moedas de prata.')
                        ...
                        if CardInHand != 0:
                            player1.SilverSerpents += 2
                            input(f'Você matou a carta da esquerda de seu oponente, e comprou 2 moedas. agora ele possui {CardInHand} carta e você tem {player1.SilverSerpents} moedas de prata.')
                            if IAplayer.IAdecision() or 'kamikaze' in Ia_use_this: IaUsesKamikaze()
                            EnemyTurn()
                        else:
                            WinGame()
...
▒▒██              ▒▒░░░░████  ██████        ██▒▒░░░░░░    
  ...
  ████          ████░░░░░░    ░░░░██                      
          ...
          ██▒▒▒▒          ██▒▒▒▒   
                    ...
                    ''')
                                input(f'Você gastou {id_card[3][1]} serpentes de prata para trazer à sua mão a carta: {id_card[resurrectedCard][0]}')
                                EnemyTurn()
                            else:
                                WinGame()
